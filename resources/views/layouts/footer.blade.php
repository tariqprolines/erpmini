<!-- /.content-wrapper -->
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="http://prolines.sa" target="_blank">Prolines.sa</a>.</strong>
    All rights reserved.
...
<script src="{{ asset('plugins/datatables/dataTables.bootstrap4.js') }}" defer></script>
