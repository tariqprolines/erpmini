     ...
     <div class="row mb-2">
       ...
       <div class="col-sm-6">
         <ol class="breadcrumb float-sm-right">
           ...
           <li class="breadcrumb-item"><a href="{{ route('brands') }}">{{ __('Brand List') }}</a></li>
             ...
             <div class="card-body">
                 <form method="POST" action="{{ route('editbrand',$brand->id) }}">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-8">
                             <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ $brand->slug }}" required autocomplete="slug">
                             @error('slug')
                                 <span class="invalid-feedback" role="alert">
                                     <strong>{{ $message }}</strong>
                                 </span>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-md-8">
                             <input id="meta_title" type="text" class="form-control" name="meta_title" value="{{ $brand->meta_title }}" >
                         </div>
                     </div>
                     <div class="form-group row">
                         <label for="meta_keyword" class="col-md-2 col-form-label text-md-right">{{ __('Meta Keyword') }}</label>
                         <div class="col-md-8">
                             <input id="meta_keyword" type="text" class="form-control" name="meta_keyword" value="{{ $brand->meta_keyword }}" >
                         </div>
                     </div>
                     <div class="form-group row">
